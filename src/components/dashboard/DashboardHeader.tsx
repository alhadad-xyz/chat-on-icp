        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            <Button variant="ghost" size="icon" className="relative hover:bg-white/50 dark:hover:bg-gray-700/50 rounded-xl">
              ...
              <Badge className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-gradient-to-r from-red-500 to-red-600 text-white text-xs flex items-center justify-center p-0 border-2 border-white dark:border-gray-800">
                3
              </Badge>
            </Button>
          </div>
